...
public interface AuthoringModelController extends AbstractGameModelController {
     ...
     *
     * @param fileToSaveTo the name to assign to the save file
     */
     ...
     * @throws IOException if the save name does not refer to existing files
     */
     ...
     * instead.
     *
     * @param elementName the template name assigned to this element, for future reuse of
     *                    the properties
     ...
     *
     * @param elementName       the name of the element to which the upgrade applies
     * @param upgradeLevel      the number upgrade this is in the element's upgrade sequence
     * @param upgradeProperties the new properties of the element when the upgrade is applied
     * @throws IllegalArgumentException if the element name does not refer to a previously defined element
     */
     ...
     *
     * @param elementName        the name of the template to be updated
     * @param propertiesToUpdate the properties to update
     * @param retroactive        whether previously created elements of this type must have their
     *                           properties updated
     ...
     *
     * @param elementName name of the template to delete
     * @throws IllegalArgumentException if the template does not already exist
     */
     ...
     *
     * @param spriteId id of the sprite whose image is to be retrieved, previously
     ...
     * @param propertiesToUpdate a map containing the new properties of the element
     */
     ...
     *
     * @param conditionIdentifier the description of the victory condition, which can be mapped to a
     ...
     *
     * @param conditionIdentifier the description of the defeat condition, which can be mapped to a
     *                            boolean state function
     */
     ...
     *
     * @param resourceEndowments map of resource name to amount of that resource to begin that
     *                           level with
     */
     ...
     *
     * @param elementName the template name for the element
     * @param unitCosts   map of resource name to cost in terms of that resource for this
     *                    element
     */
     ...
     *
     * @param waveProperties      a map containing the properties of the wave to be created
     * @param elementNamesToSpawn name of elements to spawn
     * @param spawningPoint       the point at which to spawn the wave
     */
