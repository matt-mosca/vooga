...
public class LeftToolBar extends VBox {
	...
	private void createAndAddTabs() {
		...
		staticTab.addStaticItem(new Point2D(2,1), "tortoise.png");
		staticTab.addStaticItem(new Point2D(1,2), "gray_circle.png");
		staticTab.addStaticItem(new Point2D(2,2), "green_soldier.gif");
		
		backgroundTab = new SimpleTab(myClickable, new ArrayList<>());
		backgroundTab.addBackgroundItem(new Point2D(1,2), "grass_small.png");
		backgroundTab.addBackgroundItem(new Point2D(1,1), "grass2_small.png");
		backgroundTab.addBackgroundItem(new Point2D(1,2), "brick_path.png");
		backgroundTab.addBackgroundItem(new Point2D(2,2), "stone_path1.png");
		backgroundTab.addBackgroundItem(new Point2D(1,2), "water_medium.png");
